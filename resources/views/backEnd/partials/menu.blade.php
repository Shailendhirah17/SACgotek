            ...
            <div class="header_iner d-flex justify-content-between align-items-center">
                <div class="small_logo_crm d-lg-none">
                    <a href="#">
                        @if (!is_null($generalSetting->logo))
                            <div class="sac-sidebar-brand" style="display: flex; align-items: center; gap: 8px;">
                                <svg class="sac-logo-svg" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg" style="width: 32px; height: 32px; filter: drop-shadow(0 0 5px rgba(0, 242, 254, 0.6));">
                                    <defs>
                                        <linearGradient id="sacGradMobile" x1="0%" y1="0%" x2="100%" y2="100%">
                                            <stop offset="0%" stop-color="#4facfe" />
                                            <stop offset="100%" stop-color="#00f2fe" />
                                        </linearGradient>
                                    </defs>
                                    <circle cx="50" cy="50" r="44" fill="none" stroke="url(#sacGradMobile)" stroke-width="2.5" stroke-dasharray="6 3" stroke-opacity="0.7" />
                                    <polygon points="50,16 84,26 50,36 16,26" fill="url(#sacGradMobile)" fill-opacity="0.2" stroke="url(#sacGradMobile)" stroke-width="3" stroke-linejoin="round" />
                                    <path d="M30,30 L30,44 C30,50 70,50 70,44 L70,30" fill="none" stroke="url(#sacGradMobile)" stroke-width="3" stroke-linecap="round" />
                                    <path d="M50,26 L22,32 L20,46 C20,49 18,49 18,46 L18,34" fill="none" stroke="url(#sacGradMobile)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                                    <path d="M50,76 C35,72 20,76 20,76 L20,54 C20,54 35,50 50,54 Z" fill="url(#sacGradMobile)" fill-opacity="0.15" stroke="url(#sacGradMobile)" stroke-width="3" stroke-linejoin="round" />
                                    <path d="M50,76 C65,72 80,76 80,76 L80,54 C80,54 65,50 50,54 Z" fill="url(#sacGradMobile)" fill-opacity="0.15" stroke="url(#sacGradMobile)" stroke-width="3" stroke-linejoin="round" />
                                    <line x1="50" y1="54" x2="50" y2="76" stroke="url(#sacGradMobile)" stroke-width="2.5" stroke-linecap="round" />
                                </svg>
                                <span class="brand-title" style="font-size: 18px; font-weight: 800; background: linear-gradient(135deg, #4facfe 0%, #00f2fe 100%); -webkit-background-clip: text; -webkit-text-fill-color: transparent; font-family: 'Poppins', sans-serif;">SAC</span>
                            </div>
                        @else
                            <div class="sac-sidebar-brand" style="display: flex; align-items: center; gap: 8px;">
                                <svg class="sac-logo-svg" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg" style="width: 32px; height: 32px; filter: drop-shadow(0 0 5px rgba(0, 242, 254, 0.6));">
                ...
                <div class="serach_field-area ml-40">
                    <div class="search_inner">
                        <form action="#">
                            ...
                            <button type="submit" onclick="event.preventDefault();"><i class="ti-search"></i></button>
                        </form>
                    </div>
                ...
                <div class="header_right d-flex justify-content-between align-items-center">
                    ...
                    <ul class="header_notification_warp d-flex align-items-center">
                        ...
                        @if (!generalSetting()->chatting_method  || generalSetting()->chatting_method == 'log')
                            ...
                            <div class="profile_info_details">
                                ...
                                @if (Auth::user()->role_id == '2' && Auth::user()->is_saas == 0)
                                    <a href="{{ route('student-profile') }}">
                                        <img src="{{asset('backEnd/assets/img/icons/profile.svg')}}" class="mr-1" alt="">
                                ...
                                @elseif(Auth::user()->role_id != '3' && Auth::user()->is_saas == 0 && Auth::user()->staff)
                                    <a href="{{ route('viewStaff', Auth::user()->staff->id) }}">
                                        <img src="{{asset('backEnd/assets/img/icons/profile.svg')}}" alt="">
                                        @lang('common.view_profile')
                                        {{-- <span class="ti-user"></span> --}}
                                    </a>
                                @endif
                                @if (!config('app.app_sync') && auth()->user()->role_id != 1)
                                    @if (auth()->user()->staff && auth()->user()->staff->parent_id && auth()->user()->role_id == 3)
                                        <a href="{{ route('viewAsRole') }}">
                                            ...
                                            <img src="{{asset('backEnd/assets/img/icons/key.svg')}}" alt="" class="mr-1">
                                ...
                                @if (moduleStatusCheck('Saas') == true &&
                                    ...
                                    <a href="{{ route('viewAsSuperadmin') }}">
                                        <img src="{{asset('backEnd/assets/img/icons/key.svg')}}" alt="">
                                ...
                                <a href="{{ route('updatePassowrd') }}">
                                    <img src="{{asset('backEnd/assets/img/icons/password.svg')}}" alt="">
                                ...
                                <a href="{{ Auth::user()->role_id == 2 ? route('student-logout') : route('logout') }}"
                                    ...
                                    <img src="{{asset('backEnd/assets/img/icons/logout.svg')}}" alt="">
                                    @lang('common.logout')
