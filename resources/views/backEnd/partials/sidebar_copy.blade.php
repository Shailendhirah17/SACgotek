                    ...
                    @if (auth()->user()->role_id != 2 && auth()->user()->role_id != 3)
                            ...
                            <ul class="list-unstyled">
                                <li>
                                    <a href="{{ route('tc.index') }}">
                                        <i class="fas fa-file-alt mr-1"></i> Transfer Certificate
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ route('medical.records') }}">
                                        <i class="fas fa-notes-medical mr-1"></i> Medical Records
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ route('vaccination-records') }}">
                                        <i class="fas fa-syringe mr-1"></i> Vaccination Records
                                    </a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="sortable_li">
                            <a href="javascript:void(0)" class="has-arrow" aria-expanded="false">
                                ...
                                <div class="nav_title">
                                    <span>Library &amp; Book Bank</span>
                                </div>
                            </a>
                            <ul class="list-unstyled">
                                <li>
                                    <a href="{{ route('book-bank.index') }}">
                                        <i class="fas fa-book mr-1"></i> Book Bank
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ route('thirukkural.index') }}">
                                        <i class="fas fa-book-open mr-1"></i> Thirukkural
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ route('book-bank.issue') }}">
                                        <i class="fas fa-book-reader mr-1"></i> Issue Books
                                    </a>
                                </li>
                            </ul>
                        </li>
                            ...
                            <ul class="list-unstyled">
                                <li>
                                    <a href="{{ route('vendor.index') }}">
                                        <i class="fas fa-building mr-1"></i> Vendor Management
                                    </a>
                                </li>
                                <li>
                            ...
                            <ul class="list-unstyled">
                                <li>
                                    <a href="{{ route('hostel.index') }}">
                                        <i class="fas fa-hotel mr-1"></i> Hostel List
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ route('hostel.allocation') }}">
                                        <i class="fas fa-bed mr-1"></i> Room Allocation
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ route('hostel.fee') }}">
                                        <i class="fas fa-coins mr-1"></i> Hostel Fees
                                    </a>
                                </li>
                            </ul>
                        </li>
