...
<head>
    ...
    <meta name="description" content="Ultra Super Admin Panel - Technosprint Master Control">
    <title>@yield('title', 'Ultra Super Admin') - Technosprint</title>
    ...
    <style>
        ...
        :root[data-theme="light"] {
            ...
            --usa-bg-hover: #f1f1f8;
            --usa-border: rgba(0,0,0,0.08); /* Dark border for light mode */
            --usa-border-accent: rgba(120,50,255,0.2);
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .usa-stat-card:hover { border-color: var(--usa-border-accent); transform: translateY(-2px); }
        ...
        .usa-stat-value { font-size: 28px; font-weight: 800; margin-bottom: 4px; }
...
<body>
    @include('backEnd.ultraSuperAdmin.layouts.sidebar')
    @include('backEnd.ultraSuperAdmin.layouts.header')
