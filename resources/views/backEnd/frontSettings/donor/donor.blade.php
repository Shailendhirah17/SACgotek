            ...
            <div class="col-lg-12">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        @if (isset($add_donor))
                            {{ html()->form('POST', route('donor-update'))->attributes([
                        ...
                        @else
                            @if (userPermission('donor-store'))
                                {{ html()->form('POST', route('donor-store'))->attributes([
                                        'class' => 'form-horizontal',
                                        'files' => true,
                                        'enctype' => 'multipart/form-data',
                                    ])->open() }}
                                        ...
                                        <div class="primary_input">
                                            ...
                                            <select class="primary_select  form-control" name="gender">
                                                ...
                                                @if(isset($genders) && !$genders->isEmpty())
                                                    ...
                                                    @endforeach
                                                @else
                                                    <option value="2" {{ @$add_donor->gender_id && $add_donor->gender_id == 2 ? 'selected' : '' }}>Female</option>
                                                    <option value="1" {{ @$add_donor->gender_id && $add_donor->gender_id == 1 ? 'selected' : '' }}>Male</option>
                                                    <option value="3" {{ @$add_donor->gender_id && $add_donor->gender_id == 3 ? 'selected' : '' }}>Other</option>
                                                @endif
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="row mt-20">
                                    <div class="col-lg-6">
                                        <div class="primary_input  mt-20">
                                            ...
                                            <textarea class="primary_input_field form-control" cols="0" rows="3" name="current_address"
                                                id="current_address">{{ @$add_donor->current_address ? $add_donor->current_address : old('current_address') }}</textarea>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="primary_input  mt-20">
                                            ...
                                            <textarea class="primary_input_field form-control" cols="0" rows="3" name="permanent_address"
                                                id="permanent_address">{{ @$add_donor->permanent_address ? $add_donor->permanent_address : old('permanent_address') }}</textarea>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <tbody>
                                    @foreach ($donors as $key => $value)
                                        <tr>
                                            ...
                                            <td>{{ @$value->email }}</td>
                                            <td>{{ @$value->mobile }}</td>
                                            <td>@if(@$value->photo) <img src="{{ asset(@$value->photo) }}" width="50px" height="50px"> @endif
                                            </td>
                                            <td>
                                                <x-drop-down>
