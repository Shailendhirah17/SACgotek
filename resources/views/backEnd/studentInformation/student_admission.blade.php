                                                            ...
                                                            <div class="col-lg-6 mt-4">
                                                                <div class="primary_input ">
                                                                    ...
                                                                    <input class="primary_input_field form-control{{ $errors->has('emis_id') ? ' is-invalid' : '' }}"
                                                                        type="text" name="emis_id" value="{{ old('emis_id') }}">
                                                    ...
                                                    <div class="form-section">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-12 mt-4">
                                                                <div class="primary_input ">
                                                                    ...
                                                                    <input class="primary_input_field form-control{{ $errors->has('siblings') ? ' is-invalid' : '' }}"
                                                                        type="text" name="siblings" value="{{ old('siblings') }}">
                                                            ...
                                                            <div class="col-lg-12 mt-40">
                                                                <div class="main-title">
                                                                    <h4 class="stu-sub-head">Advanced Sibling Information</h4>
                                                                </div>
                                                            </div>
                                                            <div class="col-lg-12">
...
@section('script')
    ...
    <script>
        ...
        // Advanced Sibling Script
        $(document).ready(function() {
            let class_options = '';
            @foreach($classes as $class)
                class_options += '<option value="{{$class->id}}">{{$class->class_name}}</option>';
            @endforeach

            $('#add_sibling_row').on('click', function() {
                let index = $('.sibling_row').length;
                let row = `
                <tr class="sibling_row">
                    ...
                    <td>
                        <div class="primary_input mt-2">
                            <input type="checkbox" id="is_studying_${index}" class="common-checkbox is_studying_check" name="is_studying_in_school_check[]" value="1">
                            <label for="is_studying_${index}">Yes</label>
                ...
                $('#sibling_body').append(row);
                $('#sibling_body tr:last-child .primary_select').niceSelect();
            });
            ...
            $(document).on('change', '.is_studying_check', function() {
                ...
                row.find('.is_studying_hidden').val(is_checked ? 1 : 0);
            ...
            $(document).on('change', '.sibling_class', function() {
                ...
                let url = $('#url').val();
                let section_select = row.find('.sibling_section');
                
                section_select.empty().append('<option value="">Select Section</option>');
                row.find('.sibling_student_id').empty().append('<option value="">Select Student</option>');
                
                if (class_id) {
                    $.get(url + '/student-section-loader', {id: class_id}, function(data) {
                        $.each(data[0], function(i, item) {
                            section_select.append(`<option value="${item.id}">${item.section_name}</option>`);
                        });
                        section_select.niceSelect('update');
                        row.find('.sibling_student_id').niceSelect('update');
                    });
                }
            });
            ...
            $(document).on('change', '.sibling_section', function() {
                let row = $(this).closest('tr');
                let class_id = row.find('.sibling_class').val();
                let section_id = $(this).val();
                let url = $('#url').val();
                let student_select = row.find('.sibling_student_id');
