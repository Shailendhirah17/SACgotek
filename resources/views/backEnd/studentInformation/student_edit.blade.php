...
@section('css')
    ...
    <style>
        #sibling_table .nice-select .nice-select-search-box {
            display: none !important;
        }
        #sibling_table .nice-select {
            width: 100% !important;
            padding-left: 10px !important;
            padding-right: 25px !important;
            min-width: 150px !important;
        }
        #sibling_table .nice-select .current {
        ...
        #sibling_table th, #sibling_table td {
...
@section('mainContent')
    ...
    <section class="admin-visitor-area up_st_admin_visitor">
        <div class="container-fluid p-0">
            {{ html()->form('POST', route('student_update'))->attributes([
                                                                ...
                                                                <div class="col-lg-6 mt-4">
                                                                    <div class="primary_input">
                                                                        ...
                                                                        <select
                                                                            ...
                                                                            @if(isset($genders) && !$genders->isEmpty())
                                                                                ...
                                                                                @endforeach
                                                                            @else
                                                                                <option value="2" @if(isset($student) && $student->gender_id == 2) selected @endif>Female</option>
                                                                                <option value="1" @if(isset($student) && $student->gender_id == 1) selected @endif>Male</option>
                                                                                <option value="3" @if(isset($student) && $student->gender_id == 3) selected @endif>Other</option>
                                                                            @endif
                                                                        </select>
                                                    ...
                                                    <div class="form-section">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            @if (is_show('weight'))
                                                                ...
                                                                <div class="col-lg-6 mt-4">
                                                                    <div class="primary_input">
                                                                        <label class="primary_input_label" for="">EMIS ID</label>
                                                                        <input class="primary_input_field form-control{{ $errors->has('emis_id') ? ' is-invalid' : '' }}"
                                                                            type="text" name="emis_id" value="{{ old('emis_id', $student->emis_id) }}">
                                                                        @if ($errors->has('emis_id'))
                                                                            <span class="text-danger">{{ $errors->first('emis_id') }}</span>
                                                                        @endif
                                                                    </div>
                                                                </div>
                                                            @endif
                                                        ...
                                                        @if (generalSetting()->with_guardian)
                                                            ...
                                                            <div class="parent_details" id="parent_details">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-lg-12 mt-4">
                                                                        <div class="primary_input">
                                                                            <label class="primary_input_label" for="">Siblings</label>
                                                                            <input class="primary_input_field form-control{{ $errors->has('siblings') ? ' is-invalid' : '' }}"
                                                                                type="text" name="siblings" value="{{ old('siblings', $student->siblings) }}">
                                                                ...
                                                                <div class="row mt-40">
                                                                    <div class="col-lg-12">
                                                                        <div class="main-title">
                                                                            <h3 class="mb-20">Advanced Sibling Information</h3>
                                                                        </div>
                                                                        <div class="sibling-scroll-container">
                                                                            <table class="table custom_table" id="sibling_table" style="min-width: 800px;">
                                                                                <thead>
                                                                                    <tr>
                                                                                        <th width="15%">Relation</th>
                                                                                        <th width="10%">In School?</th>
                                                                                        <th width="65%">Details (Class / Section / Student)</th>
                                                                                        <th width="10%">Action</th>
                                                                                    </tr>
                                                                                </thead>
                                                                                <tbody id="sibling_body">
                                                                                    @foreach($advanced_siblings as $count => $adv_sibling)
                                                                                    <tr class="sibling_row">
                                                                                        <td class="p-2">
                                                                                            <select class="niceSelect primary_select form-control" name="sibling_relation[]">
                                                                                                <option value="Brother" {{ $adv_sibling->sibling_relation == 'Brother' ? 'selected' : '' }}>Brother</option>
                                                                                                <option value="Sister" {{ $adv_sibling->sibling_relation == 'Sister' ? 'selected' : '' }}>Sister</option>
                                                                                            </select>
                                                                                        </td>
                                                                                        <td class="p-2">
                                                                                            <div class="primary_input mt-2">
                                                                                                <input type="checkbox" id="is_studying_edit_{{$count}}" class="common-checkbox is_studying_check" name="is_studying_in_school_check[]" value="1" {{ $adv_sibling->is_studying_in_school == 1 ? 'checked' : '' }}>
                                                                                                <label for="is_studying_edit_{{$count}}">Yes</label>
                                                                                                <input type="hidden" name="is_studying_in_school[]" class="is_studying_hidden" value="{{ $adv_sibling->is_studying_in_school }}">
                                                                                            </div>
                                                                                        </td>
                                                                                        <td class="p-2">
                                                                                            <div class="manual_entry {{ $adv_sibling->is_studying_in_school == 1 ? 'd-none' : '' }}">
                                                                                                <input class="primary_input_field form-control" type="text" name="sibling_name[]" placeholder="Sibling Name" value="{{ $adv_sibling->sibling_name }}">
                                                                                            </div>
                                                                                            <div class="school_entry {{ $adv_sibling->is_studying_in_school == 1 ? '' : 'd-none' }}">
                                                                                                <div class="d-flex gap-10">
                                                                                                    <div style="flex: 1;">
                                                                                                        <select class="primary_select form-control sibling_class" name="sibling_class_id[]">
                                                                                                            <option value="">Select Class</option>
                                                                                                            @foreach($classes as $class)
                                                                                                                <option value="{{$class->id}}" {{ $adv_sibling->class_id == $class->id ? 'selected' : '' }}>{{$class->class_name}}</option>
                                                                                                            @endforeach
                                                                                                        </select>
                                                                                                    </div>
                                                                                                    <div style="flex: 1;">
                                                                                                        <select class="primary_select form-control sibling_section" name="sibling_section_id[]">
                                                                                                            <option value="">Select Section</option>
                                                                                                            @if($adv_sibling->class_id)
                                                                                                                @php 
                                                                                                                    $sections = App\Models\SmClassSection::where('class_id', $adv_sibling->class_id)->get();
                                                                                                                @endphp
                                                                                                                @foreach($sections as $section)
                                                                                                                    <option value="{{$section->section_id}}" {{ $adv_sibling->section_id == $section->section_id ? 'selected' : '' }}>{{$section->sectionName->section_name}}</option>
                                                                                                                @endforeach
                                                                                                            @endif
                                                                                                        </select>
                                                                                                    </div>
                                                                                                    <div style="flex: 2;">
                                                                                                        <select class="primary_select form-control sibling_student_id" name="sibling_id[]">
                                                                                                            <option value="">Select Student</option>
                                                                                                            @if($adv_sibling->section_id)
                                                                                                                @php 
                                                                                                                    $students_all = App\SmStudent::where('active_status', 1)->whereHas('studentRecords', function($q) use($adv_sibling) {
                                                                                                                        $q->where('class_id', $adv_sibling->class_id)->where('section_id', $adv_sibling->section_id);
                                                                                                                    })->get();
                                                                                                                @endphp
                                                                                                                @foreach($students_all as $student_list)
                                                                                                                    <option value="{{$student_list->id}}" {{ $adv_sibling->sibling_id == $student_list->id ? 'selected' : '' }}>{{$student_list->full_name}} ({{$student_list->admission_no}})</option>
                                                                                                                @endforeach
                                                                                                            @endif
                                                                                                        </select>
                                                                                                    </div>
                                                                                        ...
                                                                                        <td class="p-2">
                                                                                            <button type="button" class="primary-btn icon-only fix-gr-bg delete_sibling_row">
                                                                        ...
                                                                        <button type="button" class="primary-btn small fix-gr-bg" id="add_sibling_row">
                                                                            <span class="ti-plus pr-2"></span> Add Sibling
                                                                        </button>
                                                                    </div>
                                                                </div>
                                                            </div>
...
@section('script')
    ...
    <script>
        ...
        $(document).on('click', '#add_sibling_row', function() {
            var rowCount = $('#sibling_table tbody tr.sibling_row').length;
            var newRow = `
                <tr class="sibling_row">
                    <td class="p-2">
                        <select class="niceSelect primary_select form-control" name="sibling_relation[]">
                    ...
                    <td class="p-2">
                        <div class="primary_input mt-2">
                            <input type="checkbox" id="is_studying_${rowCount}" class="common-checkbox is_studying_check" name="is_studying_in_school_check[]" value="1">
                            <label for="is_studying_${rowCount}">Yes</label>
                            <input type="hidden" name="is_studying_in_school[]" class="is_studying_hidden" value="0">
                        </div>
                    </td>
                    <td class="p-2">
                        <div class="manual_entry">
                            <input class="primary_input_field form-control" type="text" name="sibling_name[]" placeholder="Sibling Name">
                        </div>
                        <div class="school_entry d-none">
                            <div class="d-flex gap-10">
                                <div style="flex: 1;">
                                    <select class="primary_select form-control sibling_class" name="sibling_class_id[]">
                                        <option value="">Select Class</option>
            ...
            `;
            $('#sibling_body').append(newRow);
            $('select.niceSelect').niceSelect();
        });

        $(document).on('click', '.delete_sibling_row', function() {
            $(this).closest('tr').remove();
        });

        $(document).on('change', '.is_studying_check', function() {
            var row = $(this).closest('tr');
            if ($(this).is(':checked')) {
                row.find('.is_studying_hidden').val(1);
                row.find('.manual_entry').addClass('d-none');
                row.find('.school_entry').removeClass('d-none');
            } else {
                row.find('.is_studying_hidden').val(0);
                row.find('.manual_entry').removeClass('d-none');
                row.find('.school_entry').addClass('d-none');
            }
        });

        $(document).on('change', '.sibling_class', function() {
            var class_id = $(this).val();
            var row = $(this).closest('tr');
            var section_select = row.find('.sibling_section');
            var student_select = row.find('.sibling_student_id');
            
            section_select.empty().append('<option value="">Select Section</option>');
            student_select.empty().append('<option value="">Select Student</option>');
            
            if (class_id) {
                $.ajax({
                    url: "{{url('student-section-loader')}}",
                    type: "GET",
                    data: {class_id: class_id},
                    success: function(data) {
                        $.each(data, function(key, value) {
                            section_select.append('<option value="' + value.section_id + '">' + value.section_name + '</option>');
                        });
                        section_select.niceSelect('update');
                    }
                });
            }
            section_select.niceSelect('update');
            student_select.niceSelect('update');
        });

        $(document).on('change', '.sibling_section', function() {
            var row = $(this).closest('tr');
            var class_id = row.find('.sibling_class').val();
            ...
            if (class_id && section_id) {
                $.get(url + '/ajax-student-filter', {class: class_id, section: section_id}, function(data) {
                    $.each(data[0], function(i, item) {
                        student_select.append(`<option value="${item.id}">${item.full_name} (${item.admission_no})</option>`);
                    });
                    student_select.niceSelect('update');
                });
            }
