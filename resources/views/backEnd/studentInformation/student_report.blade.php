            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="white-box">
                        ...
                        {{ html()->form('POST', route('student_report_search'))->attributes([
                            ...
                            <div class="col-lg-3 mb-15">
                                ...
                                <select class="primary_select" name="gender">
                                    ...
                                    @if(isset($genders) && !$genders->isEmpty())
                                        ...
                                        @endforeach
                                    @else
                                        <option value="2" {{ isset($gender_id) && $gender_id == 2 ? 'selected' : '' }}>Female</option>
                                        <option value="1" {{ isset($gender_id) && $gender_id == 1 ? 'selected' : '' }}>Male</option>
                                        <option value="3" {{ isset($gender_id) && $gender_id == 3 ? 'selected' : '' }}>Other</option>
                                    @endif
                                </select>
                            </div>
