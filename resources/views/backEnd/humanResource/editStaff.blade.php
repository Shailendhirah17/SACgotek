...
@section('mainContent')
    ...
    <section class="admin-visitor-area">
        <div class="container-fluid p-0">
            ...
            {{ html()->form('GET', route('admin-dashboard'))->attributes([
                    'class' => 'form-horizontal',
                    'files' => true,
                    'enctype' => 'multipart/form-data',
                ])->open() }}
            @else
            {{ html()->form('POST', route('staffUpdate'))->attributes([
                    'class' => 'form-horizontal',
                    'files' => true,
                    'enctype' => 'multipart/form-data',
                ])->open() }}
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            @if (in_array('gender', $has_permission))
                                                                ...
                                                                selected @endif
                                                                                ...
                                                                                @endforeach
                                                                            @else
                                                                                <option value="2" @if(isset($editData) && $editData->gender_id == 2) selected @endif>Female</option>
                                                                                <option value="1" @if(isset($editData) && $editData->gender_id == 1) selected @endif>Male</option>
                                                                                <option value="3" @if(isset($editData) && $editData->gender_id == 3) selected @endif>Other</option>
                                                                            @endif
                                                                        </select>
                                                            ...
                                                            @if (in_array('current_address', $has_permission))
                                                                <div class="col-lg-6 mb-20">
                                                                    <div class="primary_input">
                                                                        ...
                                                                        <textarea class="primary_input_field form-control" cols="0" rows="4" name="current_address" id="current_address"> @if (isset($editData)){{ $editData->current_address }}@endif</textarea>
                                                            ...
                                                            @if (in_array('permanent_address', $has_permission))
                                                                <div class="col-lg-6 mb-20">
                                                                    <div class="primary_input">
                                                                        ...
                                                                        <textarea class="primary_input_field form-control" cols="0" rows="4" name="permanent_address" id="permanent_address">@if (isset($editData)){{ $editData->permanent_address }}@endif </textarea>
                                                            ...
                                                            @if (in_array('qualifications', $has_permission))
                                                                <div class="col-lg-6 mb-20">
                                                                    <div class="primary_input">
                                                                        ...
                                                                        <textarea class="primary_input_field form-control" cols="0" rows="4" name="qualification" id="qualification">@if (isset($editData)){{ $editData->qualification }}@endif </textarea>
