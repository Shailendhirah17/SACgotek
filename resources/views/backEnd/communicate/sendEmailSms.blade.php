...
@section('mainContent')
    ...
    <section class="admin-visitor-area up_admin_visitor">
        <div class="container-fluid p-0">
            {{ html()->form('POST', route('send-email-sms'))->attributes([
                                        ...
                                        <ul class="nav nav-tabs mt_0_sm mb-20" role="tablist">
                                            <li class="nav-item">
                                                <a class="nav-link active" href="#group_email_sms" selectTab="G"
                                                    role="tab" data-toggle="tab">@lang('communicate.group')</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" selectTab="I" href="#indivitual_email_sms"
                                                    role="tab" data-toggle="tab">@lang('communicate.individual')</a>
                                            </li>
                                            <li class="nav-item">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link" selectTab="B" href="#bus_vehicle_email_sms"
                                                    role="tab" data-toggle="tab">
                                                    Bus/Vehicle
                                                </a>
                                            </li>
                                        ...
                                        <div class="tab-content">
                                            ...
                                            <div role="tabpanel" class="tab-pane fade" id="indivitual_email_sms">
                                                <div class="white-box">
                                                    <div class="row mb-15">
                                                        <div class="col-lg-12">
                                                            <label for="checkbox" class="mb-2">@lang('common.role')<span
                                                                    class="text-danger"> *</span></label>
                                                            <select
                                                ...
                                                <div class="white-box">
                                                    ...
                                                    @else
                                                        <div class="row mb-35">
                                                            <div class="col-lg-12">
                                                                <label for="checkbox"
                                                                    class="mb-2">@lang('common.class')<span
                                                                        class="text-danger"> *</span></label>
                                                                <select
                                            ...
                                            <!-- Start Bus/Vehicle Tab -->
                                            <div role="tabpanel" class="tab-pane fade" id="bus_vehicle_email_sms">
                                                <div class="white-box">
                                                    <div class="row mb-35">
                                                        <div class="col-lg-12">
                                                            <label for="checkbox" class="mb-2">Bus/Vehicle<span class="text-danger"> *</span></label>
                                                            <select multiple
                                                                class="multypol_check_select active position-relative form-control{{ $errors->has('vehicle_id') ? ' is-invalid' : '' }}"
                                                                name="vehicle_id[]" id="vehicle_id_email_sms">
                                                                @if (isset($vehicles))
                                                        ...
                                                        <div class="col-lg-12 mt-30">
                                                            <label for="checkbox" class="mb-2">@lang('common.student_parent')</label>
                                                            <select multiple
                                                                class="multypol_check_select active position-relative"
                                                                name="message_to_vehicle_student_parent[]"
                                                                style="width:300px">
                                                                <option value="2">@lang('common.student')</option>
                                                                <option value="3">@lang('common.parent')</option>
                                                            </select>
