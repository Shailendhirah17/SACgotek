...
Route::group(['middleware' => ['XSS', 'subscriptionAccessUrl']], function () {
    ...
    Route::group(['middleware' => ['CheckDashboardMiddleware']], function () {
        ...
        Route::get('student-master-report', ['as' => 'student_master_report', 'uses' => 'Admin\StudentInfo\SmStudentReportController@studentMasterReport'])->middleware('userRolePermission:student_report');
        Route::post('student-master-report', ['as' => 'student_master_report_search', 'uses' => 'Admin\StudentInfo\SmStudentReportController@studentMasterReportSearch']);
    ...
    require base_path('routes/admin_school_extensions.php');
