...
Route::group(['middleware' => ['XSS', 'subdomain']], function () {
    ...
    Route::group(['middleware' => ['StudentMiddleware']], function () {
        ...
        Route::get('student-resume-creator', 'Student\SmStudentPanelController@studentResumeCreator')->name('student-resume-creator');
        ...
        // abunayem
        Route::get('student-routine-print/{class_id}/{section_id}/{exam_period_id}/{shift_id?}', 'SmExamRoutineController@examRoutinePrint')->name('student-routine-print');
