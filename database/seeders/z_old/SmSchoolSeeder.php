        ...
        SmSchool::factory()->times(1)->create()->each(
            function ($school) {
                ...
                SmAcademicYear::factory()->times(1)->create([
                    ...
                    $rules = InfixRole::where('is_saas',0)->where('active_status', '=', '1')->where('id', '!=', 1) /* ->where('id', '!=', 2) */->where('id', '!=', 3)->where('id', '!=', 10)->get();
                ...
                if (moduleStatusCheck('RazorPay') == true) {
                    ...
                    DB::table('sm_payment_gateway_settings')->insert([
                        [
                            ...
                            'gateway_client_id' => 'CLIENT_ID_PLACEHOLDER',
                            'gateway_secret_key' => 'SECRET_KEY_PLACEHOLDER',
                            'gateway_publisher_key' => 'PUBLISHER_KEY_PLACEHOLDER',
                            'school_id' => $school->id,
                        ],
                ...
                DB::table('sm_payment_gateway_settings')->insert([
                    [
                        ...
                        'gateway_client_id' => 'CLIENT_ID_PLACEHOLDER',
                        'gateway_secret_key' => 'SECRET_KEY_PLACEHOLDER',
                        'gateway_secret_word' => 'SECRET_WORD_PLACEHOLDER',
                        'school_id' => $school->id,
                    ],
                ]);
