...
class SmStudent extends Model
{
    ...
    {
        return $this->hasMany('Modules\FeesCollection\Entities\InfixAssignDiscount', 'student_id');
    }

    public function feesMasters()
    {
        return $this->hasMany('Modules\FeesCollection\Entities\InfixFeesMaster', 'class_id', 'class_id');
    }
    ...
    {
        return $this->hasMany('Modules\FeesCollection\Entities\InfixFeesPayment', 'student_id');
    }
    ...
    {
        return $this->hasMany(SmStudentSibling::class, 'student_id', 'id');
    }
