    ...
    public function feesDueSearch(Request $request)
    {
        ...
        */
            ...
            foreach ($studentRecord as $record) {
                ...
                if ($fees_assign !== '' && $total_amount > $paid) {
                    if ($request->min_due_amount && $due_amount < $request->min_due_amount) {
                        continue;
                    }
                    $fees_dues[] = $fees_assign;
                }
            ...
            $min_due_amount = $request->min_due_amount;

            return view('backEnd.feesCollection.search_fees_due', ['classes' => $classes, 'fees_masters' => $fees_masters, 'fees_dues' => $fees_dues, 'class_id' => $class_id, 'fees_group_id' => $fees_group_id, 'min_due_amount' => $min_due_amount]);
