    ...
    public function studentDelete(Request $request)
    {
        try {
            ...
            try {
                ...
                $isStaff = $parent ? SmStaff::where('user_id',$parent->user_id)->first() : null;
                ...
                $class_teacher = null;
                if ($student_detail->studentRecord) {
    ...
    public function studentPromoteCustomStore(Request $request)
    {
        ...
        try {
            ...
            if ($request->promote_class == '' || $request->promote_session == '') {
                ...
                \Illuminate\Support\Facades\Log::error('Generic error triggered'); \Illuminate\Support\Facades\Log::error('Generic error triggered'); \Illuminate\Support\Facades\Log::error('Generic error triggered'); Session::flash('message-danger', 'Something went wrong, please try again');
