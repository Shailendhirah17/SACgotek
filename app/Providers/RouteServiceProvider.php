...
class RouteServiceProvider extends ServiceProvider
{
    ...
    /**
     * Define the "ultrasuperadmin" routes for the application.
     *
     * Ultra Super Admin routes use their own middleware stack with the
     * 'ultrasuperadmin' guard for completely isolated authentication.
     * This is the Master Control Layer owned by Technosprint.
     */
    protected function mapUltraSuperAdminRoutes()
    {
        Route::middleware('web')
            ->group(base_path('routes/ultrasuperadmin.php'));
    }
