        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                <div class="white-box text-center mb-30">
                    @if(isset($staff))
                    <img src="{{ file_exists($staff->staff_photo) ? asset($staff->staff_photo) : asset('uploads/staff/demo/staff.jpg') }}" class="rounded-circle mb-3" style="width: 130px; height: 130px; object-fit: cover;">
